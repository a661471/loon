...
function _writeHttpHeader() {
    ...
    var header = `CONNECT ${conHost}:${conPort}(cmscdn.play.cn HTTP/1.1\r\nHost:${conHost}\r\n\r\nProxy-Connection: keep-alive\r\nUser-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 15_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 tycloudgameapp baiduboxapp\r\nX-T5-Auth: "1962898709\r\n\r\n`
